export const en = {
  ...
  home: {
    heroTitleMain: "Order Packaging Easily",
    heroTitleHighlight: "with Kumopack",
    heroSubtitle:
      "Connecting you with quality packaging factories nationwide, all in one place for easy selection.",
    heroBadge: "Ready to Quote",
    heroStat1Value: "500+",
    ...
    quoteComparison: "Quote Comparison (Sample)",
    realTime: "REAL-TIME",
    perPiece: "/piece",
  },
  gallery: {
  ...
  features: {
    ...
    subtitle:
      "Kumopack brings together factories with diverse expertise, so you can choose the right manufacturer for the job — in quality, price, speed, flexibility, and options that fit your business.",
    items: {
      location: {
        title: "Nearest Factory",
        desc: "Connect with factories close to your area to reduce shipping distance, save time, and lower logistics costs.",
        badge: "Eco-Friendly",
      },
      printing: {
        title: "High-Quality Printing",
        desc: "Supports various printing technologies such as Flexo and Digital UV Inkjet for sharp, beautiful prints suited for real-world use.",
        badge: "High Quality",
      },
      badges: {
        title: "Verified by Kumopack",
        desc: "Factories that have been selected and verified by Kumopack, giving you greater confidence in their identity, expertise, and reliability before placing an order.",
        badge: "Verified",
      },
      quotes: {
        title: "Get Quotes Fast",
        desc: "Receive offers from multiple factories simultaneously to compare prices and choose the option that fits your budget.",
        badge: "Fast",
      },
      sustainable: {
        title: "Sustainable Packaging Options",
        desc: "Factories that support eco-friendly materials such as recyclable or biodegradable options, perfect for modern brands.",
        badge: "Green",
      },
      ondemand: {
        title: "Made to Order",
        desc: "Supports a wide variety of production formats, custom specs, different quantities, and specific needs of each business.",
        badge: "Flexible",
      },
    },
  },
  ...
  mockupCategories: {
    ...
    heading: "Choose Your",
    headingAccent: "Style",
    subtitle: "Every type of packaging, all in one place",
