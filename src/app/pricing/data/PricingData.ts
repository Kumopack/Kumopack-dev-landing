	...
	},
	{
		...
		features: [
			...
			},
			{
				...
				tooltip: LANG.PRICING.BUYER_FEATURES.FEATURES.dielineDownloadable.TOOLTIP,
			...
			},
			{
				...
				tooltip: LANG.PRICING.BUYER_FEATURES.FEATURES.designOnlineMockup.TOOLTIP,
				standard: { status: true, word: null },
				business: { status: true, word: null },
				enterprise: { status: true, word: null },
			},
...
export const getBuyerPriceInfo = (LANG: any) => ({
	...
	plus: {
		...
		monthlyPrice: '299.00',
		annualdiscountprice: new Intl.NumberFormat('en-US', {
...
export const getSupplierPriceInfo = (LANG: any) => ({
	...
	plus: {
		...
		monthlyPrice: new Intl.NumberFormat('en-US', { minimumFractionDigits: 2 }).format(2999),
		annualPrice: new Intl.NumberFormat('en-US', {
			minimumFractionDigits: 2,
			maximumFractionDigits: 2,
		}).format(2999 * 12 * 1),
	...
	pro: {
		...
		monthlyPrice: new Intl.NumberFormat('en-US', { minimumFractionDigits: 2 }).format(4999),
		annualPrice: new Intl.NumberFormat('en-US', {
			minimumFractionDigits: 2,
			maximumFractionDigits: 2,
		}).format(4999 * 12 * 1),
...
export const getSupplierPlanFeatures = (LANG: any) => [
		...
		features: [
			{
				...
				tooltip: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.showingAdvantage.TOOLTIP,
				standard: { status: true, word: null },
				business: { status: true, word: null },
				enterprise: { status: true, word: null },
			},
			...
			},
			{
				...
				tooltip: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.bibdingOpportunity.TOOLTIP,
			...
			},
			{
				...
				tooltip: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.emailNotification.TOOLTIP,
				standard: { status: true, word: null },
				business: { status: true, word: null },
				enterprise: { status: true, word: null },
			},
			{
				...
				title: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.customerDataAnalytics.TITLE,
				tooltip: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.customerDataAnalytics.TOOLTIP,
				standard: { status: false, word: null },
				business: { status: true, word: null },
				enterprise: { status: true, word: null },
			},
			...
			},
			{
				...
				title: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.personalSupportTeam.TITLE,
				tooltip: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.personalSupportTeam.TOOLTIP,
				standard: { status: false, word: null },
				business: { status: true, word: null },
				enterprise: { status: true, word: null },
			},
			{
				...
				tooltip: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.kumopackGuarantee.TOOLTIP,
				standard: { status: false, word: null },
			...
			},
			{
				...
				tooltip: LANG.PRICING.SUPPLIER_FEATURES.FEATURES['special-content'].TOOLTIP,
				standard: { status: false, word: null },
				business: { status: false, word: null },
				enterprise: { status: true, word: null },
			},
	...
	},
	{
		...
		features: [
			...
			{
				key: 'dielineDownloadable',
				title: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.dielineDownloadable.TITLE,
				tooltip: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.dielineDownloadable.TOOLTIP,
				standard: { status: false, word: null },
				business: { status: true, word: null },
				enterprise: { status: true, word: null },
			},
			{
				...
				tooltip: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.designOnlineMockup.TOOLTIP,
				standard: { status: true, word: null },
				business: { status: true, word: null },
				enterprise: { status: true, word: null },
			},
			{
				...
				tooltip: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.AiPdfDownloadable.TOOLTIP,
				standard: { status: false, word: null },
				business: { status: true, word: null },
				enterprise: { status: true, word: null },
			},
			...
			},
			{
				...
				tooltip: LANG.PRICING.SUPPLIER_FEATURES.FEATURES.render3Dmodeling.TOOLTIP,
				standard: { status: true, word: null },
				business: { status: true, word: null },
				enterprise: { status: true, word: null },
			},
