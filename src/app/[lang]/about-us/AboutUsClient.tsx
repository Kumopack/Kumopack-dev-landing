...
export default function AboutUsClient({ dict, lang }: { dict: any; lang: string }) {
        ...
        <div className="container mx-auto max-w-6xl text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-8">
              {dict.aboutUs.title}{" "}
              <span className="text-primary">Kumopack</span>
            </h1>
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-muted-foreground uppercase tracking-wider font-semibold">
                    {dict.aboutUs.brandsTrusted}
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="text-4xl font-bold text-primary">200+</div>
                  <div className="text-sm text-muted-foreground uppercase tracking-wider font-semibold">
                    {dict.aboutUs.factoryPartners}
                  </div>
                </div>
              </div>
            </motion.div>
