        ...
        <main className="min-h-screen bg-background text-foreground">
            ...
            <section className="pt-32 pb-16 px-4 md:px-8 bg-muted/20">
                <div className="container mx-auto max-w-6xl text-center">
                    <h1 className="text-4xl md:text-6xl font-bold mb-8">How can we help you?</h1>
                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={idx} className="bg-card p-8 rounded-3xl border border-border/50 hover:border-primary/30 hover:shadow-float transition-all cursor-pointer group">
