...
const events = [
    {
        ...
        description: "Showcase your most innovative packaging designs and win up to $10,000.",
        image: "https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?auto=format&fit=crop&q=80&w=2074",
        type: "Competition",
        status: "Upcoming",
        color: "bg-coral"
    },
    {
        ...
        description: "Join industry leaders to discuss the next generation of eco-friendly materials.",
        image: "https://images.unsplash.com/photo-1591115765373-520b7a426090?auto=format&fit=crop&q=80&w=2070",
        type: "Webinar",
        status: "Live",
        color: "bg-mint"
    },
    {
        ...
        description: "Exclusively for verified suppliers. Expand your network and find new opportunities.",
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {events.map((event, idx) => (
                            <motion.div
                                ...
                                onClick={() => window.open("https://event.kumopack.com", "_blank")}
                            >
                                <div className="aspect-[4/3] relative">
                                    <SafeImage src={event.image} alt={event.title} className="w-full h-full" />
                                    <div className="absolute top-6 left-6 flex gap-2">
                                        <span className={`px-4 py-1.5 rounded-full text-white text-xs font-bold uppercase ${event.color}`}>
                                            {event.type}
                                        </span>
                                ...
                                <div className="p-10">
                                    ...
                                    <p className="text-muted-foreground leading-relaxed mb-10">{event.description}</p>
                                        ...
                                        <div className="flex -space-x-3">
                                            {[1, 2, 3].map((i) => (
                                                <div key={i} className="w-10 h-10 rounded-full border-2 border-card bg-muted flex items-center justify-center overflow-hidden">
                                                    <img src={`https://i.pravatar.cc/100?img=${i + 10}`} alt="participant" className="w-full h-full object-cover" />
                                                </div>
                                            ))}
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
                            <div className="flex-1 space-y-8">
                                <h2 className="text-4xl md:text-5xl font-extrabold text-foreground leading-tight">
                                    Have an Idea for an <span className="text-primary">Engagement?</span>
                                </h2>
                                <p className="text-lg text-muted-foreground leading-relaxed">
                                    We love collaborating with our community. If you want to host a workshop or propose an event, get in touch!
                                </p>
                                <Button variant="hero" size="lg" className="rounded-2xl px-10 py-8 text-lg">
                                    Contact Partnership
                                </Button>
                            </div>
                            <div className="flex-1 grid grid-cols-2 gap-4">
                                <div className="bg-white/50 backdrop-blur-md p-8 rounded-3xl border border-white/20 text-center space-y-4">
                                    ...
                                    <div className="text-xs font-bold uppercase text-muted-foreground">Prizes Won</div>
                                </div>
                                <div className="bg-white/50 backdrop-blur-md p-8 rounded-3xl border border-white/20 text-center space-y-4">
                                    <Trophy className="w-10 h-10 text-sky mx-auto" />
                                    <div className="text-3xl font-extrabold">150+</div>
                                    <div className="text-xs font-bold uppercase text-muted-foreground">Events Hosted</div>
                                </div>
