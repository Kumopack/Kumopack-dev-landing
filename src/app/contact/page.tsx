                    ...
                    <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        <div className="space-y-12 py-8">
                                ...
                                <div className="space-y-6">
                                    <div className="flex gap-6 items-start">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-muted-foreground text-lg">hello@kumopack.com</div>
                                        </div>
                                    </div>
                                    <div className="flex gap-6 items-start">
                                        <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center shrink-0">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-muted-foreground text-lg">+66 2 123 4567</div>
                                        </div>
                                    </div>
                                    <div className="flex gap-6 items-start">
                                        <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center shrink-0">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-muted-foreground text-lg">Sukhumvit, Bangkok, Thailand</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-primary/5 p-8 rounded-3xl border border-primary/20">
                                ...
                                <Button variant="hero" className="rounded-xl">Start Chat</Button>
                            </div>
                        </div>
                    </div>
                </div>
