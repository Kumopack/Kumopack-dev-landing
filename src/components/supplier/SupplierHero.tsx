    ...
    return (
        ...
        >
            <div className="relative">
                ...
                {/* Floating Identity Badge Overlay - Moved outside overflow-hidden */}
                <div className="absolute -bottom-12 left-6 md:left-10 flex items-end gap-5 md:gap-6 z-20">
                    ...
                    <div className="pb-14 hidden md:block">
                        ...
                        >
                            ...
                            <h1 className="text-3xl md:text-5xl font-black tracking-tight text-foreground drop-shadow-sm">{supplier.name}</h1>
                        </motion.div>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-16 md:hidden space-y-3 px-2">
                <div className="flex items-center gap-2">
                    <span className="px-2.5 py-0.5 rounded-full bg-primary/10 text-primary text-[8px] font-black uppercase tracking-widest border border-primary/5">Verified</span>
                    <span className="px-2.5 py-0.5 rounded-full bg-green-500/10 text-green-600 text-[8px] font-black uppercase tracking-widest border border-green-500/5">Gold</span>
                </div>
