...
const features = [
  {
    ...
    description:
      "Eco-friendly shipping from factories closest to you, reducing carbon footprint.",
    badge: "Eco-Friendly",
  ...
  },
  {
    ...
    description:
      "Flexo & Digital UV Inkjet technology for vibrant, lasting prints.",
    badge: "High Quality",
  ...
  },
  {
    ...
    description:
      "Verified factories with Popular, Fast Production, and On-demand labels.",
    badge: "Verified",
    badgeColor: "bg-lavender text-purple-soft",
  },
  {
  ...
  },
  {
    ...
    description:
      "No minimum orders. Get exactly what you need, when you need it.",
    badge: "Flexible",
    badgeColor: "bg-lavender text-purple-soft",
  },
];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-fade-up">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Our intelligent platform connects you with the best factories and
            features to streamline your packaging journey.
          </p>
        </div>
